...
for(var i = 0; i < leagueDetails.length; i++) {
	classes.push(leagueDetails[i][1])
...
// 選手情報表示設定
var JunNishikawa     = {x:classes, y:ranks_JunNishikawa    , name:'Jun Nishikawa',  type:'scatter', connectgaps:true, marker:{color:'rgb(0,153,0)'}}
var RyoeiHirano      = {x:classes, y:ranks_RyoeiHirano     , name:'Ryoei Hirano', type:'scatter', connectgaps:true, marker:{color:'rgb(204,0,0)'}}
var TakehiroIshidate = {x:classes, y:ranks_TakehiroIshidate, name:'Takehiro Ishidate', type:'scatter', connectgaps: true, marker:{color:'rgb(0,0,204)'}}
...
var layout = {
	title: 'The JPML League (Houousen)',
	barmode: 'stack',
	height: 700
}
