const spreadsheet_url = 'https://docs.google.com/spreadsheets/d/1h4-DhmvaBJzfkA61mTKkz4mMuICGliuzglakql5TeP0/edit?sheet=judan&headers=1'
...
//			isVisible = data.getValue(i,4)
		...
		const options = {
			...
			hAxis: {
				ticks: [{v:1,f:'初段'},{v:2,f:'二段'},{v:3,f:'三段'},{v:4,f:'四段'},{v:5,f:'五段'},{v:6,f:'六段'},{v:7,f:'六段S'},{v:8,f:'七段'},{v:9,f:'八段'},{v:10,f:'九段'},{v:11,f:'B16'},{v:12,f:'準決勝'},{v:13,f:'決勝'},{v:14,f:'十段位'}]
			},
			vAxis: {
				textStyle: {
					fontSize: 10
