const spreadsheet_url = 'https://docs.google.com/spreadsheets/d/1y8xBxGpIt-C23cwG7MDjDkebMlpnBufa4_IzYAo2QyQ/edit?sheet=英語&headers=1'
...
function drawDashboard() {
	...
	function handleQueryResponse(response) {
		...
		chartData.addColumn('string','Video')
		chartData.addColumn('string','Info')
