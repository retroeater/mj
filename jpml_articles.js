const spreadsheet_url = 'https://docs.google.com/spreadsheets/d/1h4-DhmvaBJzfkA61mTKkz4mMuICGliuzglakql5TeP0/edit?sheet=article&headers=1'
...
function getFormattedImage(title,url,imageUrl) {
	...
	formattedImage = '<a href="' + url + '" target="_blank" "><img alt="' + title + '" class="articles" loading="lazy" src="' + imageUrl + '" onError="this.onerror=null;this.src=\'' + linkIcon +'\'" /></a>'
